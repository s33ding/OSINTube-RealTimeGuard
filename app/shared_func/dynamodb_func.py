...
def log_search_to_dynamodb(video_query, s3_key, max_comments=10, max_videos=1, video_title=None, comments_found=0):
    """
    ...
    normalized_title = normalize_title(video_title or video_query)
